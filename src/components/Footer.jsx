    ...
    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      ...
      <img className="h-12 w-18 " src={logol} alt="Logo" />
        ...
        <div class="mt-[18px] flex gap-4">
          <a class="hover:scale-110" target="_blank"
            href="#"><img alt="facebook icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1"  src="https://img.icons8.com/fluent/30/000000/facebook-new.png" /></a>
            {/* <a
            class="hover:scale-110" target="_blank"
            href="/"><img alt="linkdin icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1"  src="https://www.englishyaari.com/img/linkdin.svg" /></a> */}
            <a
            class="hover:scale-110" target="_blank"
            href="/"><img alt="instagram icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1"  src="https://img.icons8.com/fluent/30/000000/instagram-new.png" /></a>
            {/* <a
            class="hover:scale-110" target="_blank"
      ...
      <div class="md:w-[316px] mt-10">
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="tel:8462880124" class="font-Inter text-[14px] font-medium ">+91-8462880124</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="mailto:Infiniteecareer@gmail.com" class="font-Inter text-[14px] font-medium ">Infiniteecareer@gmail.com</a>
            <p class="font-Inter text-[12px] font-medium ">Support Email</p>
          </div>
        </div>
        <div class="mt-[23px] flex">
          <div class="flex h-[38px] w-[38px] pl-3 items-center justify-center rounded-[75%]">
          ...
          <div class="ml-[24px]">
            <a href="https://www.google.com/maps/place/INFINITE-E+CLICKS+TECHNOLOGIES+PVT.+LTD.%7C+Digital+Marketing+agency+in+Indore/@22.757001,75.8963449,17z/data=!3m1!4b1!4m6!3m5!1s0x39631de0afe82efb:0xd18b3cd315d417e3!8m2!3d22.7569961!4d75.8989198!16s%2Fg%2F11g2zx986j?entry=ttu" class="font-Inter text-[14px] font-medium ">132/1,Vasant Vihar Colony,Behind Satya Sai School near Satya Sai Square,Indore, Madhya Pradesh 452010</a>
      ...
      <div class="mt-6 flex w-full flex-col justify-between  sm:flex-row md:mt-0 md:max-w-[341px]">
        <div class="mt-4">
          <p class="text-deutziawhite font-inter text-[18px] font-medium leading-normal">Quick Links</p>
          <ul>
            <li class="mt-[15px]"><a
